...
export default async function handler(req, res) {
  ...
  if (['save', 'retire', 'resetCode'].includes(op) && !who.master && !who.manager) {
    return res.status(403).json({ error: 'Only managers sign the team up, reset codes, or edit members' });
  }
