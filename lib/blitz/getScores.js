...
/*
  ...
  so no one is exposed before they participate. Trigrams in lib/excluded.js are
  filtered too — this is the game's OWN leaderboard, on its own /api/blitz
  namespace, so it does not inherit anything applied to /api/recroom. It was
  missed when the exclusion first shipped on 2026-08-26 and kept showing the
  two excluded players at the top of NAM while the REC Room scoreboard next to
  it correctly did not. If you add a player-listing endpoint in EITHER
  namespace, filter it here too.
